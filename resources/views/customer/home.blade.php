...
@section('content')
<div class="min-h-screen bg-gray-900 pb-10 md:pb-20">
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6">
        ...
        <div class="relative -mt-16 md:-mt-24 bg-gray-700 rounded-3xl shadow-xl p-6 md:p-8 border border-gray-700 flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
            ...
            <div class="flex-1 text-center md:text-left">
                <div class="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                    <h1 class="text-2xl md:text-4xl font-extrabold text-white tracking-tight">{{ $info->name ?? 'Resto' }}</h1>
                ...
                <div class="mt-4 space-y-2 md:space-y-0 md:grid md:grid-cols-2 md:gap-4 text-white">
                    ...
                    <div class="flex items-center justify-center md:justify-start gap-2 md:gap-3">
                        ...
                        <p class="text-sm md:text-lg">
                            ...
                            <span class="font-semibold text-white">{{ $info->open_time ?? '09:00' }} - {{ $info->close_time ?? '21:00' }}</span>
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-8 md:mt-10 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <a href="{{ route('customer.table.index') }}" 
                       class="group flex items-center justify-center md:justify-start gap-4 bg-blue-600 text-white px-6 md:px-8 py-4 rounded-2xl shadow-lg hover:bg-blue-700 transition-all active:scale-95">
        ...
        <div class="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <div class="bg-gray-700 p-5 rounded-2xl shadow-sm border border-gray-700 flex md:flex-col items-center gap-4 md:text-center transition hover:shadow-md">
                <div class="text-3xl bg-orange-50 w-14 h-14 flex items-center justify-center rounded-xl md:mx-auto md:mb-2">⭐</div>
                <div>
                    <h3 class="font-bold text-white">Kualitas Terbaik</h3>
                    <p class="text-xs md:text-sm text-gray-200">Bahan segar pilihan setiap hari.</p>
                </div>
            </div>
            ...
            <div class="bg-gray-700 p-5 rounded-2xl shadow-sm border border-gray-700 flex md:flex-col items-center gap-4 md:text-center transition hover:shadow-md">
                ...
                <div>
                    <h3 class="font-bold text-white">Pelayanan Cepat</h3>
                    <p class="text-xs md:text-sm text-gray-200">Pesanan prioritas utama kami.</p>
                </div>
            </div>
            ...
            <div class="bg-gray-700 p-5 rounded-2xl shadow-sm border border-gray-700 flex md:flex-col items-center gap-4 md:text-center transition hover:shadow-md">
                ...
                <div>
                    <h3 class="font-bold text-white">Bayar Aman</h3>
                    <p class="text-xs md:text-sm text-gray-200">Tunai maupun QRIS tersedia.</p>
                </div>
            </div>
        </div>
    </div>
